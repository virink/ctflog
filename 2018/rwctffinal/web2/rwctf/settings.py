...
SECRET_KEY = os.environ.get(
    'SECRET_KEY', 'y5fc9nypwm%x1w^plkld4y#jwgrd)$ys6&!cog^!3=xr5m4#&-')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # os.environ.get('DEBUG', '0') in ('True', 'true', '1', 'TRUE')
...
DATABASES = {
    'default': dj_database_url.config(conn_max_age=600, default='sqlite:////tmp/dbx.sqlite3')
}
