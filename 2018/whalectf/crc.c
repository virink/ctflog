...
void check_ans(int* value_data, char* info_value, char* input_data)
{
    ...
    {
        //part one
        v_tmp = value_data[2 * (unsigned __int8)(v_tmp ^ info_value[i + 17]) + 1] ^ ((unsigned int)v_tmp >> 8);
        //part two
        // v_tmp = value_data[2 * (unsigned __int8)(v_tmp ^ info_value[i + 16])] ^ ((unsigned int)v_tmp >> 8);
    }
    v_tmp = ~v_tmp;
    //part one
    if (v_tmp == -943542018)
...
int main()
{
    char info_value[] = {126, 39, 96, 55, 72, 99, 54, 51, 55, 53, 0, 0, 0, 0, 0, 0, 83,
    ...
    111, 111, 100, 32, 99, 111, 109, 112, 117, 116, 101, 114, 46, 73, 116, 32, 115, 101,
    101, 109, 115, 32, 116, 104, 97, 116, 32, 84, 104, 105, 115, 32, 112, 114, 111, 98,
    108, 101, 109, 32, 119, 105, 108, 108, 32, 116, 97, 107, 101, 32, 97, 32, 108, 111,
    116, 32, 111, 102, 32, 116, 105, 109, 101, 46, 66, 117, 116, 32, 110, 111, 116, 32,
    116, 104, 105, 110, 103, 32, 105, 115, 32, 105, 109, 112, 111, 115, 115, 105, 98, 108,
    101, 46, 83, 111, 32, 106, 117, 115, 116, 32, 116, 114, 121, 32, 105, 116, 33, 33, 83,
    111, 109, 101, 32, 116, 105, 109, 101, 115, 44, 84, 104, 101, 32, 116, 104, 105, 110,
    103, 32, 119, 101, 32, 115, 101, 101, 109, 32, 105, 115, 32, 110, 111, 116, 32, 114,
    101, 97, 108, 108, 32, 91, 93, 91, 93, 40, 41, 40, 41, 60, 62, 60, 62, 46, 46};
    ...
    0x26a1e7e8, 0x9e6495a3, 0xd4ca64eb, 0xedb8832, 0x8ad958cf, 0x79dcb8a4, 0x78b2dbcc,
    0xe0d5e91e, 0x6be22838, 0x97d2d988, 0x9989ab3b, 0x9b64c2b, 0x4d43cfd0, 0x7eb17cbd,
    0xbf284cd3, 0xe7b82d07, 0xac78bf27, 0x90bf1d91, 0x5e133c24, 0x1db71064, 0x105ec76f,
    0x6ab020f2, 0xe235446c, 0xf3b97148, 0xf165b798, 0x84be41de, 0x30e349b, 0x1adad47d,
    0xd7c45070, 0x6ddde4eb, 0x25afd373, 0xf4d4b551, 0x36ff2087, 0x83d385c7, 0xc494a384,
    ...
    0x45df5c75, 0x9f95c20d, 0xdcd60dcf, 0x8cc531f9, 0xabd13d59, 0x7eaeb2fa, 0x26d930ac,
    0x30e349b1, 0x51de003a, 0xc288cab2, 0xc8d75180, 0xd1d83946, 0xbfd06116, 0x23b3ba45,
    0x21b4f4b5, 0xf779deae, 0x56b3c423, 0x5125dad, 0xcfba9599, 0x1642ae59, 0xb8bda50f,
    ...
    0x8cd37cf3, 0xfd5d65f4, 0xfbd44c65, 0xf36e6f7, 0x4db26158, 0x61c69362, 0x3ab551ce,
    ...
    0x44042d73, 0x2c855cb2, 0x33031de5, 0xdeeedfb1, 0xaa0a4c5f, 0xcdbe2c45, 0xdd0d7cc9,
    ...
    0x1b7f9043, 0xe40ecf0b, 0xcfb5f4a8, 0x9309ff9d, 0x3dde77ab, 0xa00ae27, 0x2e8e845f,
    ...
    0xea1a27db, 0x10da7a5a, 0xf94ad42f, 0x67dd4acc, 0xb21572c, 0xf9b9df6f, 0xdfeb33c7,
    0x8ebeeff9, 0x2d80b0c4, 0x17b7be43, 0x3ed04330, 0x60b08ed5, 0xccbbc033, 0xd6d6a3e8,
    ...
    0x41047a60, 0x3bc21e9d, 0xdf60efc3, 0xef087a76, 0xa867df55, 0x1d63f975, 0x316e8eef,
    ...
    0x40df0b66, 0x88d28022, 0x37d83bf0, 0x7ab90321, 0xa9bcae53, 0xae7367ca, 0xdebb9ec5,
    ...
    0xb3667a2e, 0x79b737ba, 0xc4614ab8, 0x8bdcb4b9, 0x5d681b02, 0x988c474d, 0x2a6f2b94,
